...
-- =================================================================
-- TABLAS Y POLÍTICAS DE OBLIGACIONES Y SSOT PROYECCIÓN
-- =================================================================

-- Cuentas bancarias (soporte para referencias de obligaciones)
...
-- Egresos Recurrentes (plantillas de costos fijos)
...
-- Pagos de Obligaciones (Trazabilidad de ejecuciones reales)
...
-- Snapshots de Proyección (Congelar estimaciones históricas)
